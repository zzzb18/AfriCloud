...
def main(daily_arr):
        ...
        for keyword,cityName in zip(locations,cityNames):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    day_valid = 0  # 当天有一个景点请求失败

            except requests.exceptions.RequestException as e:
                error_msg = f"请求异常: {str(e)}"
                print(f"关键词 '{keyword}' {error_msg}")
                day_valid = 0  # 当天有一个景点请求异常
    ...
    return json.loads(json.dumps(result, ensure_ascii=0))
